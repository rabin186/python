...
var e, n, r;
e = Q, 58 === t.charCodeAt(Q) ? (n = q, Q++) : (n = o, 0 === se && ce(M));
n !== o && (r = ve()) !== o ? (ee = e, e = n = I(r)) : (Q = e, e = a);
return e;
...
function ve() {
var e, n, r, s;
if (e = Q, ge() !== o) if (46 === t.charCodeAt(Q) ? (n = U, Q++) : (n = o, 0 === se && ce($)), 
n !== o) {
...
n !== o) {
for (r = [], J.test(t.charAt(Q)) ? (s = t.charAt(Q), Q++) : (s = o, 0 === se && ce(K)); s !== o; ) r.push(s), 
J.test(t.charAt(Q)) ? (s = t.charAt(Q), Q++) : (s = o, 0 === se && ce(K));
...
r = a), r !== o && (s = be()) !== o ? (ee = n, n = r = G(s)) : (Q = n, n = a), n !== o) for (;n !== o; ) t.push(n), 
n = Q, r = Q, se++, (s = fe()) === o && (s = me()), se--, s === o ? r = O : (Q = r, 
r = a), r !== o && (s = be()) !== o ? (ee = n, n = r = G(s)) : (Q = n, n = a); else t = a;
...
//# sourceMappingURL=frontpage.dea12daf6a9518afa220.js.map